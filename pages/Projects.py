...
st.subheader("LinkedIn Jobs Scraping | Python")
...
st.markdown("""
	...
	●	Developed dynamic snake animation and size adjustments in a snake game by using precise position detection to enhance both visual appeal and gameplay dynamics.
            ...
            """,unsafe_allow_html=True)
st.markdown("""<strong>Link: </strong>
        <a href='https://www.youtube.com/watch?v=crLJT-QD8rI'><u style='color:blue'>Snake</u></a> -
        <a href = 'https://github.com/hongantran3804/Snake'><u style = 'color:blue'> Github</u></a>
            """,unsafe_allow_html=True)
################################################################
st.subheader("Credit Score Prediction | Python")
